package main.javafx.cellFactories;
...
public class TextFieldCellFactory
        implements Callback<TableColumn<ValueRow,String>, TableCell<ValueRow,String>> {

    @Override
    public TableCell<ValueRow, String> call(TableColumn<ValueRow, String> param) {
        TextFieldCell textFieldCell = new TextFieldCell();
        return textFieldCell;
    }

    public static class TextFieldCell extends TableCell<ValueRow,String> {
        ...
        protected void updateItem(String item, boolean empty) {
            ...
            if(!empty) {
                ...
                Logger.log("item=" + item + " ObservableValue<String>=" + ov.getValue());
